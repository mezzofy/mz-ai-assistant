...
- **mz-ai-assistant mobile v1.18.0 (2026-03-12) ✅ COMPLETE:** MS Contacts backend (FEAT-013); version label sync fix. versionCode 30. RULE: THREE places must always be updated on every version bump: (1) `APP/android/app/build.gradle` versionCode+versionName, (2) `APP/package.json` version, (3) `APP/src/screens/SettingsScreen.tsx` hardcoded label. React Native does NOT auto-sync these. Commit: 6f2bc2c.
